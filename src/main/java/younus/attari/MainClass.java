...
public class MainClass {
	...
	static {
		...
		prop.setProperty("hibernate.connection.url", "jdbc:mysql://mysql.transcriptionhub.com/dbhybrid_transcription");
		prop.setProperty("hibernate.connection.username", "hybrid_trans");
		prop.setProperty("hibernate.connection.password", "trans#123");
		...
		factory = new Configuration().addPackage("younus.attari").addAnnotatedClass(Employee.class)
				...
				.addAnnotatedClass(Address.class).addProperties(prop)
				.buildSessionFactory();
